...
The views manager window reflects the Khiops Covisualization interface. 
...
Khiops Covisualization can integrate external data associated to each cluster element. 
...
After the import ("Load datas" button), Khiops Covisualization displays these data in the "external data" view.
