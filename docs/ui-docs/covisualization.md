...
By clicking on the button : ![](../assets/images-khiops-guides/covisualization/image10.png), you can add or remove different views on each dimension.
...
![](../assets/images-khiops-guides/covisualization/image10a.png)
...
![](../assets/images-khiops-guides/covisualization/image27.png)
...
In the example below, the upper histogram represents the distribution of “education” given the selected cluster “A10” of occupation. The lower histogram represents the distribution of “occupation” given the selected cluster “Masters” of “education”.

![](../assets/images-khiops-guides/covisualization/image29.png)
...
The co-occurrence matrix allows a direct visualization of both partitions jointly. The current hierarchy of each dimension is represented on one chart. The horizontal axis corresponds to the first dimension, the vertical axis to the second one. Axis can be switched using the button : ![](../assets/images-khiops-guides/covisualization/image33.png)
...
![](../assets/images-khiops-guides/covisualization/image41.png)
...
![](../assets/images-khiops-guides/covisualization/image46-a.png)
