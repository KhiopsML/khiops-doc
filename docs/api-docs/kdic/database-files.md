...
Missing or erroneous numerical values are replaced by a missing system value (–infinity, to avoid collision with any valid value).
...
![](../../assets/images-khiops-guides/khiops/image7.png) 
