...
[`VectorC`](/api-docs/kdic/vector-rules/#vectorc) rules of the same size, with unique keys in the
`keyVector`.
...
[`VectorC`](/api-docs/kdic/vector-rules/#vectorc) and
[`Vector`](/api-docs/kdic/vector-rules/#vector) rules of the same size, with unique keys in the
vector of keys.
