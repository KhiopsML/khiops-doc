...
right-open intervals, use comparison derivation rules, such as [`G`](../numerical-comparisons/#g),
[`GE`](../numerical-comparisons/#ge), [`L`](../numerical-comparisons/#l) or
[`LE`](../numerical-comparisons/#le).
