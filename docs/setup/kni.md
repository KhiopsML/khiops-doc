...
All the basics to install and use the Khiops Native Interface is available at this [github project](https://github.com/KhiopsML/KNI-tutorial/tree/{{ KHIOPS_VERSION }}).